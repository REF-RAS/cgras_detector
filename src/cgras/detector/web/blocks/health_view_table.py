...
class HealthViewTable():
    def __init__(self, app, prefix, page_size=50, refresh_cycle=10):
        ...
        self._menu_panel = dbc.Row([
            dbc.Col([dbc.Button('Explore Status', id=prefix+'table_view_button', n_clicks=0, color='primary', className='mb-1 me-1', size='sm', 
                               disabled=True, external_link=True, target='count_view', style={'width': '120px'}),
    ...
    def _row_selected(self):
        def row_selected(selected_rows, page_current, page_size, model):
            if not selected_rows or len(selected_rows) == 0:
                return (None, True, self._style_data_conditional)
            ...
            return (href, False, style_data_conditional)
        return row_selected  
