...
class DetectMinipage():
    def __init__(self, app, prefix=''):
        self.app = app
        try:
            self.splash_url = f'https://cms.qut.edu.au/__data/assets/image/0005/1236758/csp-science.jpg'
        except:
    ...
    def _define_panel(self): 
        self._splash_card = dbc.Card([dbc.CardBody([
            html.H3('Welcome to CGRAS DETECT COUNT Minipage'),                  
            dbc.Button('Start', id='detect_change_state_button', color='primary', className='w-50', size='lg')]),
        ...
        # - define callbacks         
        self.app.callback([Output('detect_change_state_button', 'n_click')],
                            [Input('detect_change_state_button', 'n_clicks_timestamp')], 
    ...
    def _button_pressed(self):
        def button_pressed(start_button):
            ...
            if button_id == 'detect_change_state_button':
                model.STATE.update_state(model.SystemStates.IDLE)
            raise PreventUpdate
