...
from cgras.detector.web.blocks import ResetDBBlock, DiskspaceBlock, FileSpaceSaver, TileInfoImportFileBlock, TileStatBlock, SpawningSeasonChangeBlock, ResetStatDBTableBlock
...
class AdminSetupPage():
    def __init__(self, app):
        ...
        self.tile_info_import_block = TileInfoImportFileBlock(app, prefix)
        self.tile_stat_block = TileStatBlock(app, prefix)
        
        self.spwaning_season_block = SpawningSeasonChangeBlock(app, prefix)
        self._define_page()
