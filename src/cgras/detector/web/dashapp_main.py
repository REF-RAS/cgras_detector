...
class DashApplicationMain():
    ...
    def _define_app(self):
        self._navbar_with_menu = dbc.NavbarSimple(
                    ...
                    brand=html.Div([html.H3('CGRAS Coral Counting and Visualization'), html.H6('Robotics and Autonomous Systems Group, REF, RI, Queensland University of Technology')]),
                    brand_href='/page_monitor', color='#cce6ff', className='fs-4 text')

        self._navbar_simple = dbc.NavbarSimple(
                    brand=html.H3('CGRAS Coral Counting and Visualization'), color='#99cccc', className='fs-4 text')      
