...
from cgras.detector.web.blocks import CountTileSelectTable, CoralCountTileInfoBlock, CountTileTrendBlock, CountHeatmapBlock, CountResultDownloadBlock, CountScatterMapBlock

dash.register_page(__name__)

# -- define the GUI components of this page
class CountDisplayPage():
