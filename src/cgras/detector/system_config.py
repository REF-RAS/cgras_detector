...
class SystemConfigNames(Enum):
    ...
    DETECTOR_SUBFOLDER = 'data_system_subfolder'
    WEB_HOST = 'web_host'
    WEB_PORT = 'web_port'
...
if __name__ == '__main__':
    ...
    print(f'{type(SystemConfigNames.DATA_FOLDER)}')
    print(f'{isinstance(SystemConfigNames.DATA_FOLDER, Enum)}')
    print(f'{CONFIG[SystemConfigNames.DATA_FOLDER]}')
    print(f'{CONFIG.get(SystemConfigNames.DATA_FOLDER)}')
