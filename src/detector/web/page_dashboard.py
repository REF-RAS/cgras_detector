...
class DashboardPage():
    ...
    def _define_page(self):
        ...
        self.process_task_control_panel.register_trigger(self.update_store_id)
        self.monitor_state_panel.register_trigger(self.update_store_id)
        ...
        self._panel = html.Div(id='scan-body',children = [
            ...
            dbc.Row(html.H3(children = 'Image Analysis and Task Execution Dashboard', className='mt-3 mb-3')),
            dbc.Row([
