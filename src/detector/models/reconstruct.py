...
class ImageReconstructModel():
    ...
    def print_info(self):
        ...
        self.logger.info(f'Whole reco image size: {self.whole_reco_image_size}')
        self.logger.info(f'Whole reco image origin offset: {self.whole_reco_image_origin_offset}')
