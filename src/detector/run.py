...
from detector.model import APP_FILE_MANAGER, STATE, CONFIG, SystemStates, DETECT_DAO, PERSISTENT_STORE_DAO, AIMSTILE_DAO, SystemConfigNames, StatusNames, TaskTypes, CallbackTypes
...
class ApplicationCoordinator(object):
    ...
    def __init__(self):
        ...
        model.CALLBACK_MANAGER.set_listener(model.CallbackTypes.PROCESS_TILE_TO_ABORT, self._console_callback) 
